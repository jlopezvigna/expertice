              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  {typeof testimonial.src === "string" ? (
                    ...
                    <div className="h-[200px] w-[200px] bg-white rounded-3xl flex items-center justify-center">
                      {testimonial.src}
                    </div>
                  )}
                </motion.div>
        ...
        <div className="flex flex-col justify-between py-4 col-span-2">
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <motion.p className="mt-2 text-md text-gray-500 dark:text-neutral-300">
              ...
              {testimonials[active].bulletPoints && (
